...
POSTS = [
    ...
    ("hibah-untuk-content-creator.png", "HIBAH",
     "Hibah Untuk\nGig Worker & Freelancer",
     "Takde Boss, Takde EPF.\nBina Perlindungan Sendiri"),
    ...
    ("gl-medical-card-decline.png", "MEDICAL CARD",
     "GL Medical Card\nKena Decline?",
     "5 Sebab & Apa Nak Buat"),
    ...
    ("kes-sebenar-medical-card.png", "MEDICAL CARD",
     "Kes Sebenar:",
     "Kenapa Medical Card\nBenar-Benar Penting"),
    ("medical-card-lengkap-2026.png", "MEDICAL CARD",
     "Medical Card Lengkap 2026",
     "Perlindungan RM1.5 Juta\n& Health Wallet NCB"),
    ("medical-card-sebut-harga.png", "MEDICAL CARD",
     "Medical Card\nRM1.5 Juta++",
     "Umur 30 Dari RM169/Bulan.\nSemak Caruman 10 Saat"),
    ("medical-card-untuk-content-creator.png", "MEDICAL CARD",
     "Medical Card Untuk\nContent Creator",
     "Sihat Pun Dapat Ganjaran.\nTanpa Perlu Company"),
    # PENYAKIT KRITIKAL
